...
public class BoardManager {
    ...
    public BoardManager(BoardAdapter adapter, int updateTick) {
        ...
        Bukkit.getPluginManager().registerEvents(new BoardListener(this), FrozedLib.INSTANCE.getPlugin());
        Bukkit.getScheduler().runTaskTimer(FrozedLib.INSTANCE.getPlugin(), this::sendScoreboard,0,updateTick);
    }
